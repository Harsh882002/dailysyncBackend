 ...
 export const registerAdmin = async (req, res) => {
   const { name, email, password, confirmPassword, department, designation,role } =
     req.body;
   ...
   try {
     ...
     const [result] = await db.execute(
       "INSERT INTO users(name, email,password,department,designation,role) VALUES (?,?,?,?,?,?)",
       [name, email, hashPass, department, designation,role]
     );
